...
import controller.ControllerInterfaceController;
        ...
        try {
            ...
            while (rsSqlReceitas.next()) {
                ...
                if (receitaDisponivel == true) {
                    ...
                    ControllerInterfaceController.receitasDisponiveis = receitasDisponiveis;
                } else {
                    String receitasIndisponiveis = "[" + numReceita + "] - " + nomeReceita + " - indisponível.";
                    ControllerInterfaceController.receitasIndisponiveis = receitasIndisponiveis;
                }
                numReceita++;
